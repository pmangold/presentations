...
\begin{frame}{Context, idea on a nice analysis (I) \footfullcite{samsonov2024improved}}
...
\begin{frame}[t]{Context, idea on a nice analysis (II) \footfullcite{samsonov2024improved}}
...
\begin{frame}[t]{Context, idea on a nice analysis (III) \footfullcite{samsonov2024improved}}
...
%\end{frame}
  ...
  \begin{frame}{In the General Case\\[-0.5em]
      \small (Strongly convex and smooth functions)}
    ...
    \begin{itemize}
    \item $\textbf{A} = (I \otimes \nabla^2 f(\theta_\star) + \nabla^2 f(\theta_\star) \otimes I)^{-1}$
